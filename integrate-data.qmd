...
- Review the [Controlled Vocabulary & Thesauri](reference_info/data_standards/controlled-vocabulary-thesauri.qmd) for standard terms
- Check the [Salmon Data Exchange Package Specification](reference_info/data_standards/salmon-data-exchange-package.qmd) for integration patterns
- Explore [R tools](reference_info/tools/r_packages.qmd) for automated integration workflows
